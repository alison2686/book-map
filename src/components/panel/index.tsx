  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <div className='flex flex-col items-center justify-center lg:h-screen '>
        <div className='comic-bg border-4 border-black lg:max-w-screen-lg h-full flex flex-col items-center justify-center overflow-y-auto scrollbar-hide cursor-pointer hover:shadow-lg'>
