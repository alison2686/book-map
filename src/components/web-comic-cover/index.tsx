...
const ComicCover = () => {
  return (
    <div className=''>
      <div className='comic-dots border-4 border-black w-3/4 h-full flex flex-col items-center justify-center mx-auto p-4'>
        <h1 className='comic-cover-title md:text-5xl lg:text-7xl text-center'>
          Becoming American: <br /> A 600-Year Odyssey
        </h1>
        <h2 className='mt-4 md:mt-8 text-sm md:text-base lg:text-lg  max-w-2xl'>
